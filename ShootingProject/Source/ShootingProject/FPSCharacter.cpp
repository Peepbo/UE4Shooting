...
AFPSCharacter::AFPSCharacter()
{
	...
	FPSCameraComponent = CreateDefaultSubobject<UCameraComponent>(TEXT("FistPersonCamera"));
...
void AFPSCharacter::Fire()
{
	if (ProjectileClass)
	{
		...
		if (World)
		{
			...
			AFPSProjectile* Projectile = World->SpawnActor<AFPSProjectile>(ProjectileClass, MuzzleLocation,
